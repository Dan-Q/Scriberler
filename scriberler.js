...
const letters = {
  ...
  J: { steps: 3, css: { marginLeft: '5px'} },
  K: { steps: 3, css: { marginLeft: '15px'} },
  L: { steps: 3, css: { marginLeft: '-30px'} },
  M: { steps: 3, css: { marginLeft: '15px'} },
  N: { steps: 3, css: { marginLeft: '10px'} },
  O: { steps: 3, css: {} },
  P: { steps: 3, css: { marginLeft: '-20px'} },
  Q: { steps: 3, css: { marginLeft: '5px'} },
  R: { steps: 3, css: { marginLeft: '-30px'} },
  S: { steps: 3, css: {} },
  T: { steps: 4, css: {} },
